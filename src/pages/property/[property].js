                ...
                <div className=" px-4 relative order-2 mt-0 h-full lg:h-screen overflow-scroll scrollbar-hide lg:order-2 lg:px-0 col-span-12 lg:col-span-6 xl:col-span-5">
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        <div>
                            ...
                            <p className='text-[#200955] font-semibold'>{selectedCard?.beds}</p>
                        </div>
                        <div>
                            <p className='text-[#8f8f8f] text-[0.9rem]'>Bathrooms</p>
                            <p className='text-[#200955] font-semibold'>{selectedCard?.bath}</p>
                        </div><div>
                        ...
                        <div>
                            ...
                            <p className='text-[#200955] font-semibold'>{selectedCard?.sqft} <sub>sq ft</sub></p>
                        </div>            <div>
                        ...
                        <div>
                            ...
                            <p className='text-[#200955] font-semibold'>{selectedCard?.location}</p>
                        </div>
                    </div>
                    <br />
                    ...
                    <p className='pt-2'>{selectedCard?.overview}</p>
